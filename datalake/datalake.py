...
class Datalake:
    ...
    def sightings_filtered_from_atom_value(self, atom_value: str, limit: int = None, offset: int = None,
                                           ordering: str = None, organization_id: int = None,
                                           organization_name: str = None, start_timestamp_date: str = None,
                                           end_timestamp_date: str = None, tags: list = None,
                                           sighting_type: SightingType = None, visibility: Visibility = None):
        ...
        return self.Sightings.sightings_filtered(hashkey, limit, offset, ordering, organization_id, organization_name, start_timestamp_date, end_timestamp_date, tags, sighting_type, visibility)
